...
It starts at zero and ticks up 1 unit per second
At 50 it appears on the bar and counts twoards 90
...
If month hits 12 it's reset to 1, same goes for the day but with 31
-Clicking toggle MpH/KMpH will alter the speed on the home screen and print which is 
now being presented in the console (Note:The speed is being read in from a file then converted)
